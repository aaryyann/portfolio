...
const techStack = [
  ...
  { name: 'TypeScript', icon: <SiTypescript className="text-blue-500" />, category: 'Programming' },
  ...
  { name: 'WebSocket', icon: <BiNetworkChart className="text-green-400" />, category: 'Real-time' },
  ...
  { name: 'Turborepo', icon: <SiTurborepo className="text-orange-400" />, category: 'Architecture' },
];
