...
const SocialLinks: React.FC = () => {
  const socialLinks = [
    { name: 'LinkedIn', icon: <Linkedin size={20} />, url: 'https://www.linkedin.com/in/aryan-gupta-020034258/', color: 'bg-[#0077B5]' },
    { name: 'GitHub', icon: <Github size={20} />, url: 'https://github.com/aaryyann', color: 'bg-[#333333]' },
    { name: 'Twitter', icon: <Twitter size={20} />, url: 'https://x.com/im_arya45', color: 'bg-[#1DA1F2]' },
